...
| [terraform-aws-storage](modules/terraform-aws-storage/) | Module for creation or reuse of S3 storage buckets for CDP on AWS. Handles data, log, and backup buckets with support for KMS encryption, versioning, and public access blocks. Note that this module is called from the terraform-cdp-aws-prereqs module. |
...
| [terraform-azure-storage](modules/terraform-azure-storage/README.md) | Module for creation creation of Azure Storage Accounts and containers required for Cloudera Data Platform. Note that this module is called from the terraform-cdp-zure-prereqs module.|
